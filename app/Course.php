    ...
    public function courseData($course_name){
      $course=[
        'speech_open'=>[
          'title'=>'《魅力口才》实战培训课程',
          'key'=>'魅力口才',
          'subtitle'=>'口才赢得未来，沟通改变人生。',
          'quote'=>[
            "口才赢得未来，沟通改变人生。找工作、找对象、开会、培训、聚会、谈生意、交朋友、演讲、发言、升职、创业……一切的一切，都离不开口才！",
            "邓宏伟老师曾经为海能达、泰天恒集团、正一道场、正雄鞋材、建顺包材等众多企业的学员们讲授了《魅力口才》实战课程，受到了企业和学员们的一致好评。",
            '邓老师将在近期在深圳市南山区举行《魅力口才》实战公开课。',
          ],
          'value'=>'课程价值',
          'value_list'=>[
            '针对学习口才面临的各种障碍：',
            '性格内向、不够自信、不善沟通、缺乏激情、不想说话、不敢说话、表情僵硬、缺乏内容、没有条理、上台紧张、语无伦次、手足无措等，',
            '提供有效的解决方法，并在现场进行精心设计的多种演练，',
            '现场就让学员产生积极、可喜的变化。',
          ],
          'gain'=>'课程要点',
          'gain_list'=>[
          ...
          'time'=>' 7月8日(周六)上午9:00—9:30签到，9:30—17:30上课',
