  ...
  <div class="container marketing">
    ...
    <div class="card-deck">
      <div class="card">
        ...
        <p class="text-center"><a class="btn btn-secondary" href="/course/com" role="button">查看详情 &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
        <div class="card">
          ...
          <p class="text-center"><a class="btn btn-secondary" href="/course/sun" role="button">查看详情 &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="card">
