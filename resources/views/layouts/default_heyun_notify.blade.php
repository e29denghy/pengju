...
<html>
  <head>
    ...
    <title>@yield('title', '深圳') - 一訸一舍</title>
    <!-- Bootstrap core CSS -->
  ...
  <body>
    <main role="main">
        @if("mobile"==$mobile_device)
          @include('layouts._header_bottom_heyun_notify')
        @else
          @include('layouts._header_heyun')
        @endif
        @include('shared._messages_notify')
        @yield('content')
        @if("pc"==$mobile_device)
          @include('layouts._footer_heyun')
        @endif
    </main>
